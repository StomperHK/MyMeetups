...
function MainHeader(props) {
  const {anchorToGetUnderlinedState} = props
  ...
  return (
    <header className={styleClasses.mainHeader}>
      ...
      <nav>
        <Link 
          className={`text-and-symbol-aligner ${anchorToGetUnderlinedState === 'first-anchor' ? styleClasses.underlinedAnchor : ''}`} 
          to="/"
        >
        ...
        <Link 
          className={`text-and-symbol-aligner ${anchorToGetUnderlinedState === 'second-anchor' ? styleClasses.underlinedAnchor : ''}`}
          to="/bookmarks"
        >
