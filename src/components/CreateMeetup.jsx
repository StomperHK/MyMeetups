import styleClasses from '../scss/CreateMeetup.module.scss'

function CreateMeetup(props) {
  const {meetupCreatorModalState, changeMeetupCreatorModalState} = props

  return (
    <button className={styleClasses.createMeetupWrapper} onClick={() => changeMeetupCreatorModalState(!meetupCreatorModalState)}>
      <div>
